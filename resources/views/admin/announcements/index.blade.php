        ...
        <table class="table adm-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="POST" action="/admin/announcements/{{ $a->id }}" class="d-inline" onsubmit="return confirm('确认删除该公告？')">@csrf @method('DELETE')<button class="btn btn-danger btn-sm">删除</button></form>
                </td>
            </tr>
