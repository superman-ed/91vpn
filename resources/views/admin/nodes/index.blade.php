...
<div class="card adm-panel">
    <div class="table-responsive">
        <table class="table adm-table">
            <thead><tr><th>ID</th><th>名称</th><th>地址:端口</th><th>协议</th><th>倍率</th><th>等级门槛</th><th>状态</th><th>操作</th></tr></thead>
            <tbody>
            @forelse($nodes as $n)
            <tr>
                ...
                <td>
                    ...
                    <form method="POST" action="/admin/nodes/{{ $n->id }}" class="d-inline" onsubmit="return confirm('确认删除该节点？')">@csrf @method('DELETE')<button class="btn btn-danger btn-sm">删除</button></form>
                </td>
            </tr>
            @empty<tr><td colspan="8"><div class="adm-empty"><i class="fas fa-server fa-2x mb-2 d-block"></i>暂无节点，点右上角「添加节点」</div></td></tr>@endforelse
            </tbody>
        </table>
    </div>
</div>
