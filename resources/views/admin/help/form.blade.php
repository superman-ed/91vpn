...
<div class="form-group col-md-6"><label>排序</label><input name="sort" type="number" value="{{ old('sort',$item->sort ?? 0) }}" class="form-control"><small class="text-muted">越大越靠前</small></div>
</div>
