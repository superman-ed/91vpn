...
<thead><tr><th>码</th><th>备注</th><th>类型</th><th>额度</th><th>适用时长</th><th>已用/上限</th><th>到期</th><th>状态</th><th>操作</th></tr></thead><tbody>
...
@empty<tr><td colspan="9" class="text-muted">暂无优惠券</td></tr>@endforelse
