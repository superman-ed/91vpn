        ...
        <table class="table adm-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                        <form method="POST" action="/admin/admins/{{ $u->id }}" class="d-inline" onsubmit="return confirm('确认撤销该管理员权限？TA 将变回普通用户。')">@csrf @method('DELETE')<button class="btn btn-outline-danger btn-sm">撤销管理员</button></form>
                    @endif
                </td>
            </tr>
