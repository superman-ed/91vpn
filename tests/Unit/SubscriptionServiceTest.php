...
it('generates clash yaml with nodes the user can access', function () {
    ...
    Node::create(['name' => '香港01', 'server' => 'hk.example.com', 'port' => 10086, 'type' => 'vmess', 'net' => 'tcp', 'traffic_rate' => 1, 'node_class' => 0, 'online' => true, 'secret' => 's1']);
    Node::create(['name' => '高级美国', 'server' => 'us.example.com', 'port' => 20086, 'type' => 'vmess', 'net' => 'tcp', 'traffic_rate' => 1, 'node_class' => 3, 'online' => true, 'secret' => 's2']); // class3 用户看不到
...
it('populates Proxy group with all node names', function () {
    $user = makeActiveUser();
    Node::create(['name' => '香港01', 'server' => 'hk.example.com', 'port' => 10086, 'type' => 'vmess', 'net' => 'tcp', 'traffic_rate' => 1, 'node_class' => 0, 'online' => true, 'secret' => 's1']);
    Node::create(['name' => '日本01', 'server' => 'jp.example.com', 'port' => 10087, 'type' => 'vmess', 'net' => 'tcp', 'traffic_rate' => 1, 'node_class' => 0, 'online' => true, 'secret' => 's2']);
