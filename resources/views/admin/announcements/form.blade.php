...
<div class="row">
<div class="form-group col-md-6"><label>发布</label><select name="published" class="form-control"><option value="1" @selected(old('published',$item->published ?? 1))>发布</option><option value="0" @selected(!old('published',$item->published ?? 1))>草稿</option></select></div>
