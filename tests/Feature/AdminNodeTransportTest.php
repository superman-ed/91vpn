...
it('clash config carries ws-opts and tls for ws node', function () {
    ...
    Node::create(['name' => 'WS01', 'server' => 'ws.example.com', 'port' => 443, 'type' => 'vmess', 'net' => 'ws', 'path' => '/ray', 'host' => 'cdn.io', 'tls' => true, 'traffic_rate' => 1, 'node_class' => 0, 'online' => true, 'secret' => 's1']);
...
it('regenerates node secret', function () {
    $node = Node::create(['name' => 'N', 'server' => 's', 'port' => 1, 'type' => 'vmess', 'net' => 'tcp', 'traffic_rate' => 1, 'node_class' => 0, 'online' => true, 'secret' => 'oldsecret']);
